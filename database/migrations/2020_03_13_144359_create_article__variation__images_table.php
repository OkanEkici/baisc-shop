...
class CreateArticleVariationImagesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('article__variation__images', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('article__variation__images');
    }
}
